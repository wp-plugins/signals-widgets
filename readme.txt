...
Widgets pack for WordPress. Spice up your blog with these super awesome widgets and add more functionality to it.
...
1. Upload `signals-widgets` folder to the `/wp-content/plugins/` directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. Go to the 'Widgets' section under 'Appearance' panel and start using the widgets.
