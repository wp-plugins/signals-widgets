	...
	<div class="signals-body">
		<div class="signals-tile" style="display: block !important">
			<div class="signals-single-section">
				...
				<p><?php _e( 'Now that you have activated this plugin, all the widgets will appear in the Widgets section of your WordPress panel. Simply select the widget you would like to use and you are done. You don\'t have to configure anything. It\'s that simple.', 'signals' ); ?></p>
